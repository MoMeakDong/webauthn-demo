...
router.post('/register', (request, response) => {
    ...
    let publicKeyCredentialCreationOptions = utils.generateServerMakeCredRequest(username, name, database[username].id)
    publicKeyCredentialCreationOptions.status = 'ok'
